...
import type { FeedContextType } from "src/components/contexts/ToggleFeedContext";
import { FeedContext } from "src/components/contexts/ToggleFeedContext";
...
export default function Nav() {
  const { feed, setFeed } = useContext<FeedContextType>(FeedContext);
      ...
      <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
        <div className="relative flex h-16 items-center justify-between">
          <div className="flex flex-1 items-center justify-center  sm:items-stretch sm:justify-start">
            ...
            <div className="absolute hidden w-full items-center self-center sm:block">
              <div className="flex justify-center">
                <button
                  className={classNames(
                    ...
                    "rounded-l-md border-t border-b border-l border-black px-6 text-lg font-bold"
                  )}
                ...
                <button
                  className={classNames(
                    !feed
                      ? "bg-white text-black"
                      : "bg-black text-white hover:bg-gray-700",
                    "rounded-r-md border border-black px-6 text-lg font-bold"
                  )}
