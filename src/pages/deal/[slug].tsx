      ...
      <div className="sm:py-26 mx-auto px-4 pt-2 pb-20 sm:px-6  lg:max-w-7xl lg:px-8">
        ...
        <div className="flex justify-between">
          <div className="w-2/3">
            ...
            <p className="mt-8 font-bold text-black text-xl">What's included</p>
            <p className="mt-4 text-black">{deal?.description}</p>
            <p>
          ...
          <div className="w-md">
            <div className=" sticky top-10 mt-16">
              <div>
                <div className="mt-2 flex p-4 items-center">
                  <div className="border-2 rounded-xl p-4 ">
                    ...
                    <p className="mt-4 font-semibold">Valid until 12/12/2020</p>
